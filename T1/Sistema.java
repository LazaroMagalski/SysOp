...
public class Sistema {
	...
	public class GM{
		...
		public void desaloca(int[] tablaPaginas){
			return;
		}
	}
	public class Memory {
		...
		public Program[] progs = {
			new Program("sum",
				new Word[]{
					...
					new Word(Opcode.ADD, 0, 1, -1), //soma e coloca no registrador 0
					new Word(Opcode.STD, 0, -1, 5), // coloca valor de r0 na memoria DATA
