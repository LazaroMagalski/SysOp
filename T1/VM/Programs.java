...
public class Programs {
        ...
        public Program[] progs = {
                        new Program("sum",
                                        new Word[] {
                                                        new Word(Opcode.LDI, 0, -1, 7), // registrador r0 = 7
                                                        new Word(Opcode.LDI, 1, -1, 5), // registrador r1 = 5
                                                        new Word(Opcode.ADD, 0, 1, -1), // soma e coloca no registrador
                                                                                        // 0
                                                        new Word(Opcode.STD, 0, -1, 5), // coloca valor de r0 na memoria
                                                                                        // DATA
                        ...
                        new Program("fatorial",
                                        new Word[] {
                                                        ...
                                                        new Word(Opcode.STD, 1, -1, 10), // 8 coloca valor de r1 na
                                                                                         // posição 10
                                                        new Word(Opcode.STOP, -1, -1, -1), // 9 stop // 10 ao final o
                                                                                           // valor está na posição 10
                                                                                           // da memória
                                                        new Word(Opcode.DATA, -1, -1, -1) // 11 valor de parametro
                                        }),
                        new Program("fatorialIN",
                                        new Word[] {
                                                        new Word(Opcode.LDI, 0, -1, 7), // 0: valor base do fatorial
                                                                                        // (ex: 7)
                                                        ...
                                                        new Word(Opcode.STD, 1, -1, 12), // 8: salva resultado em 10
                                                        new Word(Opcode.IN, 13, -1, -1), // 9: lê valor do usuário para
